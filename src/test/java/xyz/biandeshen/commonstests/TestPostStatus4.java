...
public class TestPostStatus4 {
	...
	private String postStatusToURL(String nowStr) {
		...
		postParameters.add("data", nowStr);
		
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
		//headers.setContentType(MediaType.APPLICATION_JSON_UTF8);
		
		HttpEntity<Map<String, Object>> httpEntity = new HttpEntity<>(postParameters, headers);
		...
		String resStr = "";
		try {
			resStr = URLDecoder.decode(result.getBody(), StandardCharsets.UTF_8.toString());
	...
	private String GOT = "{\"clientFlag\":\"" + clientFlag + "\",\"mailNo\":\"" + mailNo + "\",\"orderNo\":\"" + orderNo + "\",\"time\":\"" + nowTime + "\",\"desc\":\"已取件,到达[北京_朝阳营业所_崇文门营业厅]\",\"city\":\"北京市\",\"facilityType\":\"1\",\"facilityNo\":\"1076\",\"facilityName\":\"北京_朝阳营业所_崇文门营业厅\",\"action\":\"GOT\",\"tz\":\"8\",\"country\":\"China\"}";
	private String ARRIVAL = "{\"clientFlag\":\"" + clientFlag + "\",\"mailNo\":\"" + mailNo + "\",\"orderNo\":\"" + orderNo + "\",\"time\":\"" + nowTime + "\",\"desc\":\"到达[北京_朝阳营业所_崇文门营业厅]\",\"city\":\"北京市\",\"facilityType\":\"1\",\"facilityNo\":\"1076\",\"facilityName\":\"北京_朝阳营业所_崇文门营业厅\",\"action\":\"ARRIVAL\",\"tz\":\"8\",\"country\":\"China\"}";
	private String DEPARTURE = "{\"clientFlag\":\"" + clientFlag + "\",\"mailNo\":\"" + mailNo + "\",\"orderNo\":\"" + orderNo + "\",\"time\":\"" + nowTime + "\",\"desc\":\"离开[北京_朝阳营业所_崇文门营业厅]发往[辽宁_于洪广场独立仓]\",\"city\":\"北京市\",\"facilityType\":\"1\",\"facilityNo\":\"1076\",\"facilityName\":\"北京_朝阳营业所_崇文门营业厅\",\"action\":\"DEPARTURE\",\"tz\":\"8\",\"nextCity\":\"北京市\",\"nextNodeCode\":\"18363\",\"nextNodeName\":\"辽宁_于洪广场独立仓\",\"country\":\"China\"}";
	private String SENT_SCAN = "{\"clientFlag\":\"" + clientFlag + "\",\"mailNo\":\"" + mailNo + "\",\"orderNo\":\"" + orderNo + "\",\"time\":\"" + nowTime + "\",\"desc\":\"离开[北京_朝阳营业所_崇文门营业厅] 派送中 \",\"city\":\"北京市\",\"facilityType\":\"1\",\"facilityNo\":\"1076\",\"facilityName\":\"北京_朝阳营业所_崇文门营业厅\",\"action\":\"SENT_SCAN\",\"tz\":\"8\",\"country\":\"China\",\"contacter\":\"张辉1\",\"contactPhone\":\"18001395384\"}";
	private String SIGNED = "{\"clientFlag\":\"" + clientFlag + "\",\"mailNo\":\"" + mailNo + "\",\"orderNo\":\"" + orderNo + "\",\"time\":\"" + nowTime + "\",\"desc\":\"客户已签收\",\"city\":\"北京市\",\"facilityType\":\"1\",\"facilityNo\":\"1076\",\"facilityName\":\"北京_朝阳营业所_崇文门营业厅\",\"action\":\"SIGNED\",\"tz\":\"8\",\"country\":\"China\",\"signer\":\"test\"}";
	private String FAILED = "{\"clientFlag\":\"" + clientFlag + "\",\"mailNo\":\"" + mailNo + "\",\"orderNo\":\"" + orderNo + "\",\"time\":\"" + nowTime + "\",\"city\":\"北京市\",\"facilityType\":\"1\",\"facilityNo\":\"1202\",\"facilityName\":\"北京_朝阳营业所_崇文门营业厅\",\"action\":\"FAILED\",\"tz\":\"8\",\"country\":\"China\",\"signer\":\"返货\"}";
