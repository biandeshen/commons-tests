...
public class PGPUtils
{
     ...
     */
    @SuppressWarnings("unchecked")
    public static void decryptFile(InputStream in, String outputFileName, InputStream keyIn, char[] passwd)
            throws Exception {
...
//            System.out.println(pbe.getKeyID());
//
//            if ("6161320553814213903".equals(pbe.getKeyID())) {
//                sKey = findPrivateKey(keyIn, pbe.getKeyID(), passwd);
//            }
//            if (pbe.getKeyID() ==Long.valueOf("6161320553814213903")) {
//                sKey = findPrivateKey(keyIn, pbe.getKeyID(), passwd);
//            }
//        }
        ...
        if (message instanceof PGPLiteralData) {
            ...
            //if (size == 0) {
            //    throw new Exception(" 解析文件后文件为空  重新解析 ");
            //}

            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            List<Integer> listio=new ArrayList<>();
