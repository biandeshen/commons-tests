...
public class RestTemplateConfig {
	...
	public ClientHttpRequestFactory createFactory() {
		...
		HttpComponentsClientRestfulHttpRequestFactory factory = new HttpComponentsClientRestfulHttpRequestFactory(this.createHttpClient());
		factory.setConnectTimeout(this.connectTimeout);
		factory.setReadTimeout(this.readTimeout);
		return factory;
	}
	...
	public CloseableHttpAsyncClient asyncHttpClient() {
		try {
			...
			RequestConfig config = RequestConfig.custom().setConnectTimeout(connectTimeout).setConnectionRequestTimeout(connectionRequestTimeout).setSocketTimeout(readTimeout).build();
