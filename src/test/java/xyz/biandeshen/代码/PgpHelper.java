...
public class PgpHelper {
	 ...
	 */
	public PGPPrivateKey findSecretKey(PGPSecretKeyRingCollection pgpSec, long keyID, char[] pass) throws IOException, PGPException, NoSuchProviderException {
		PGPSecretKey pgpSecKey = pgpSec.getSecretKey(keyID);
		if (pgpSecKey == null) {
			return null;
		}
		//PBESecretKeyDecryptor bc = new JcePBESecretKeyDecryptorBuilder().setProvider("BC").build(pass);
