### Java中lambda表达式解析
> **_Java中lambda表达式的本质就是函数式接口的具体实现类的实例对象。_**
...
//		System.out.println("operate = " + operate);
//	}
//  此时，匿名类与具体实现类只是形式不同，但它们都是接口的实现类，且方法相同


//  我们还可以通过简化匿名类的写法，将匿名类转换为lambda表达式的写法。
...
//  Java中，当我们知道方法名称与方法参数的个数、类型及顺序时，就能确定一个方法，
