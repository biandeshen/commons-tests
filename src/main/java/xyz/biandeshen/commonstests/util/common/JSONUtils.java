...
public class JSONUtils {
	 ...
	 */
	public static String objectToJsonStrImpl(Object obj) {
	 ...
	 * @date 2018/12/13 15:56
	 */
	public static String beanToJsonStrImpl(Object bean) {
		StringBuilder json = new StringBuilder();
		json.append("{");
	 ...
	 */
	public static String listToJsonStrImpl(List<?> list) {
		StringBuilder json = new StringBuilder();
		json.append("[");
	 ...
	 * @date 2018/12/13 16:53
	 */
	public static String arrayToJsonStrImpl(Object[] array) {
		StringBuilder json = new StringBuilder();
		json.append("[");
	 ...
	 * @date 2018/12/13 16:53
	 */
	public static String setToJsonStrImpl(Set<?> set) {
		StringBuilder json = new StringBuilder();
		json.append("[");
	 ...
	 * @date 2018/12/13 16:53
	 */
	public static String mapToJsonStrImpl(Map<?, ?> map) {
		StringBuilder json = new StringBuilder();
		json.append("{");
	...
	public static <T> List<Map<String, T>> getListByUrlStrImpl(String url) {
		try {
			//通过HTTP获取JSON数据
			StringBuilder sb;
			try (InputStream in = new URL(url).openStream(); BufferedReader reader = new BufferedReader(new InputStreamReader(in, StandardCharsets.UTF_8))) {
